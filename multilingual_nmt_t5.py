...
model_params={
    ...
    "VALID_BATCH_SIZE":256,          # validation batch size
    "TRAIN_EPOCHS":3,              # number of training epochs
    "VAL_EPOCHS":1,                # number of validation epochs
    "LEARNING_RATE":1e-4,          # learning rate
    "MAX_SOURCE_TEXT_LENGTH":36,  # max length of source text
    "MAX_TARGET_TEXT_LENGTH":125,   # max length of target text
